...
const PlanTrip = () => (
    <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4'>
        ...
        <div className='flex flex-col h-full justify-center'>
            ...
            <p className='text-2xl py-6'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias cum ab esse!</p>
            <p className='pb-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Et architecto nobis itaque perferendis ab ipsum minima cum illum!</p>
            <button className='border-black hover:shadow-2xl mb-2'>Learn More</button>
            <button className='bg-black text-white border-black hover:shadow-2xl'>Book Now</button>
        </div>
    </div>
)
